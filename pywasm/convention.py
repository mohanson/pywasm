...
loop = op(0x03, 'loop', ['leb_7'], 0)
if_ = op(0x04, 'if', ['leb_7'], 0)
else_ = op(0x05, 'else', [], 0)
end = op(0x0b, 'end', [], 0)
br = op(0x0c, 'br', ['leb_32'], 0)
...
f64_load = op(0x2b, 'f64.load', ['leb_32', 'leb_32'], 8)
i32_load8_s = op(0x2c, 'i32.load8_s', ['leb_32', 'leb_32'], 1)
i32_load8_u = op(0x2d, 'i32.load8_u', ['leb_32', 'leb_32'], 1)
i32_load16_s = op(0x2e, 'i32.load16_s', ['leb_32', 'leb_32'], 2)
i32_load16_u = op(0x2f, 'i32.load16_u', ['leb_32', 'leb_32'], 2)
i64_load8_s = op(0x30, 'i64.load8_s', ['leb_32', 'leb_32'], 1)
i64_load8_u = op(0x31, 'i64.load8_u', ['leb_32', 'leb_32'], 1)
i64_load16_s = op(0x32, 'i64.load16_s', ['leb_32', 'leb_32'], 2)
i64_load16_u = op(0x33, 'i64.load16_u', ['leb_32', 'leb_32'], 2)
i64_load32_s = op(0x34, 'i64.load32_s', ['leb_32', 'leb_32'], 4)
i64_load32_u = op(0x35, 'i64.load32_u', ['leb_32', 'leb_32'], 4)
i32_store = op(0x36, 'i32.store', ['leb_32', 'leb_32'], 4)
i64_store = op(0x37, 'i64.store', ['leb_32', 'leb_32'], 8)
f32_store = op(0x38, 'f32.store', ['leb_32', 'leb_32'], 4)
f64_store = op(0x39, 'f64.store', ['leb_32', 'leb_32'], 8)
i32_store8 = op(0x3a, 'i32.store8', ['leb_32', 'leb_32'], 1)
i32_store16 = op(0x3b, 'i32.store16', ['leb_32', 'leb_32'], 2)
i64_store8 = op(0x3c, 'i64.store8', ['leb_32', 'leb_32'], 1)
i64_store16 = op(0x3d, 'i64.store16', ['leb_32', 'leb_32'], 2)
