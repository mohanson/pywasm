...
nop = op(0x01, 'nop', '', 0)
block = op(0x02, 'block', 'complex', 0)
loop = op(0x03, 'loop', 'complex', 0)
if_ = op(0x04, 'if', 'complex', 0)
...
call = op(0x10, 'call', 'complex', 0)
call_indirect = op(0x11, 'call_indirect', 'complex', 0)
