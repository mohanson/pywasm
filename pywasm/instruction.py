...
local_get = op(0x20, 'local.get')
local_set = op(0x21, 'local.set')
local_tee = op(0x22, 'local.tee')
global_get = op(0x23, 'global.get')
global_set = op(0x24, 'global.set')
...
memory_size = op(0x3f, 'memory.size')
memory_grow = op(0x40, 'memory.grow')
...
i32_lt_s = op(0x48, 'i32.lt_s')
i32_lt_u = op(0x49, 'i32.lt_u')
i32_gt_s = op(0x4a, 'i32.gt_s')
i32_gt_u = op(0x4b, 'i32.gt_u')
i32_le_s = op(0x4c, 'i32.le_s')
i32_le_u = op(0x4d, 'i32.le_u')
i32_ge_s = op(0x4e, 'i32.ge_s')
i32_ge_u = op(0x4f, 'i32.ge_u')
i64_eqz = op(0x50, 'i64.eqz')
i64_eq = op(0x51, 'i64.eq')
i64_ne = op(0x52, 'i64.ne')
i64_lt_s = op(0x53, 'i64.lt_s')
i64_lt_u = op(0x54, 'i64.lt_u')
i64_gt_s = op(0x55, 'i64.gt_s')
i64_gt_u = op(0x56, 'i64.gt_u')
i64_le_s = op(0x57, 'i64.le_s')
i64_le_u = op(0x58, 'i64.le_u')
i64_ge_s = op(0x59, 'i64.ge_s')
i64_ge_u = op(0x5a, 'i64.ge_u')
...
i32_div_s = op(0x6d, 'i32.div_s')
i32_div_u = op(0x6e, 'i32.div_u')
i32_rem_s = op(0x6f, 'i32.rem_s')
i32_rem_u = op(0x70, 'i32.rem_u')
i32_and = op(0x71, 'i32.and')
i32_or = op(0x72, 'i32.or')
i32_xor = op(0x73, 'i32.xor')
i32_shl = op(0x74, 'i32.shl')
i32_shr_s = op(0x75, 'i32.shr_s')
i32_shr_u = op(0x76, 'i32.shr_u')
...
i64_div_s = op(0x7f, 'i64.div_s')
i64_div_u = op(0x80, 'i64.div_u')
i64_rem_s = op(0x81, 'i64.rem_s')
i64_rem_u = op(0x82, 'i64.rem_u')
i64_and = op(0x83, 'i64.and')
i64_or = op(0x84, 'i64.or')
i64_xor = op(0x85, 'i64.xor')
i64_shl = op(0x86, 'i64.shl')
i64_shr_s = op(0x87, 'i64.shr_s')
i64_shr_u = op(0x88, 'i64.shr_u')
...
i32_trunc_f32_s = op(0xa8, 'i32.trunc_f32_s')
i32_trunc_f32_u = op(0xa9, 'i32.trunc_f32_u')
i32_trunc_f64_s = op(0xaa, 'i32.trunc_f64_s')
i32_trunc_f64_u = op(0xab, 'i32.trunc_f64_u')
i64_extend_i32_s = op(0xac, 'i64.extend_i32_s')
i64_extend_i32_u = op(0xad, 'i64.extend_i32_u')
i64_trunc_f32_s = op(0xae, 'i64.trunc_f32_s')
i64_trunc_f32_u = op(0xaf, 'i64.trunc_f32_u')
i64_trunc_f64_s = op(0xb0, 'i64.trunc_f64_s')
i64_trunc_f64_u = op(0xb1, 'i64.trunc_f64_u')
f32_convert_i32_s = op(0xb2, 'f32.convert_i32_s')
f32_convert_i32_u = op(0xb3, 'f32.convert_i32_u')
f32_convert_i64_s = op(0xb4, 'f32.convert_i64_s')
f32_convert_i64_u = op(0xb5, 'f32.convert_i64_u')
f32_demote_f64 = op(0xb6, 'f32.demote_f64')
f64_convert_i32_s = op(0xb7, 'f64.convert_i32_s')
f64_convert_i32_u = op(0xb8, 'f64.convert_i32_u')
f64_convert_i64_s = op(0xb9, 'f64.convert_i64_s')
f64_convert_i64_u = op(0xba, 'f64.convert_i64_u')
