(module $blake2b_simd.wasm
  ...
  (type (;7;) (func (param i32 i32 i64 i64 i64 i64)))
  ...
  (func $alloc_zeroed (type 3) (param i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $blake2b (type 4) (param i32 i32 i32 i32)
    (local i32 v128)
    global.get $__stack_pointer
    i32.const 624
    i32.sub
  ...
  (func $_RNvCs691rhTbG0Ee_7___rustc12___rust_alloc (type 1) (param i32 i32) (result i32)
    ...
    local.get 2
    return)
  (func $_RNvCs691rhTbG0Ee_7___rustc14___rust_dealloc (type 5) (param i32 i32 i32)
    local.get 0
    local.get 1
    local.get 2
    call $_RNvCs691rhTbG0Ee_7___rustc13___rdl_dealloc
    return)
  (func $_RNvCs691rhTbG0Ee_7___rustc14___rust_realloc (type 6) (param i32 i32 i32 i32) (result i32)
    (local i32)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_RNvCs691rhTbG0Ee_7___rustc26___rust_alloc_error_handler (type 0) (param i32 i32)
    ...
    return)
  (func $_ZN8blake2ya7blake2b6reduce17h592ec0095d14d42bE (type 7) (param i32 i32 i64 i64 i64 i64)
  ...
  (func $_ZN8blake2ya7blake2b7Param2b6digest17h72a2d9ccd477238dE (type 0) (param i32 i32)
    ...
    local.get 1
    i32.store8)
  (func $_ZN8blake2ya7blake2b7Blake2b6update17h6af962144cc2c580E (type 5) (param i32 i32 i32)
    ...
    unreachable)
  (func $_ZN8blake2ya7blake2b7Blake2b6digest17h7e289db40c319d9fE (type 5) (param i32 i32 i32)
  ...
  (func $_ZN8blake2ya7blake2b7blake2b17h855b19c6cd048e5bE (type 0) (param i32 i32)
    ...
    local.get 2
    local.get 2
    v128.load offset=136 align=8
    v128.const i32x4 0xf3bcc908 0x6a09e667 0x84caa73b 0xbb67ae85
    v128.xor
    v128.store offset=264 align=8
    local.get 2
    local.get 2
    v128.load offset=152 align=8
    v128.const i32x4 0xfe94f82b 0x3c6ef372 0x5f1d36f1 0xa54ff53a
    v128.xor
    v128.store offset=280 align=8
    local.get 2
    local.get 2
    v128.load offset=168 align=8
    v128.const i32x4 0xade682d1 0x510e527f 0x2b3e6c1f 0x9b05688c
    v128.xor
    v128.store offset=296 align=8
    local.get 2
    local.get 2
    v128.load offset=184 align=8
    v128.const i32x4 0xfb41bd6b 0x1f83d9ab 0x137e2179 0x5be0cd19
    v128.xor
    v128.store offset=312 align=8
    block  ;; label = @1
      local.get 2
  ...
  (func $_ZN36_$LT$T$u20$as$u20$core..any..Any$GT$7type_id17hffe704d8309d203aE (type 0) (param i32 i32)
    ...
    i64.store)
  (func $_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$7reserve21do_reserve_and_handle17h9d7cabd5071c5a51E (type 8) (param i32 i32 i32 i32 i32)
  ...
  (func $_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17h37d546d4b358ccb9E (type 9) (param i32)
    (local i32)
    block  ;; label = @1
      local.get 0
      i32.load
  ...
  (func $_ZN4core3ptr77drop_in_place$LT$std..panicking..begin_panic_handler..FormatStringPayload$GT$17h328305dd0d118fb6E (type 9) (param i32)
    (local i32)
    block  ;; label = @1
      local.get 0
      i32.load
  ...
  (func $_ZN58_$LT$alloc..string..String$u20$as$u20$core..fmt..Write$GT$9write_str17h7850057311a0cef1E (type 2) (param i32 i32 i32) (result i32)
    ...
    i32.store offset=8
    i32.const 0)
  (func $_ZN5alloc7raw_vec11finish_grow17h31fcfb118e0508a4E (type 4) (param i32 i32 i32 i32)
    (local i32)
    block  ;; label = @1
      local.get 2
      i32.const 0
  ...
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$18insert_large_chunk17h36f158d3d0e17661E (type 0) (param i32 i32)
    ...
    local.get 0
    i32.store offset=8)
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$4free17hd05ac7097937f97bE (type 9) (param i32)
  ...
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$8memalign17h0e39a8832380600bE (type 1) (param i32 i32) (result i32)
    ...
    local.get 2)
  (func $_ZN3std3sys9backtrace26__rust_end_short_backtrace17h16ab72765b32282dE (type 9) (param i32)
    local.get 0
    call $_ZN3std9panicking19begin_panic_handler28_$u7b$$u7b$closure$u7d$$u7d$17h23ff416a921468b4E
    unreachable)
  (func $_ZN3std9panicking19begin_panic_handler28_$u7b$$u7b$closure$u7d$$u7d$17h23ff416a921468b4E (type 9) (param i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_RNvCs691rhTbG0Ee_7___rustc11___rdl_alloc (type 1) (param i32 i32) (result i32)
    ...
    local.get 0
    call $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$6malloc17h90ff8eedc9c6744dE)
  (func $_RNvCs691rhTbG0Ee_7___rustc13___rdl_dealloc (type 5) (param i32 i32 i32)
    (local i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 0
    ...
    call $_ZN4core9panicking5panic17hcb4f0bfb9f36a348E
    unreachable)
  (func $_RNvCs691rhTbG0Ee_7___rustc13___rdl_realloc (type 6) (param i32 i32 i32 i32) (result i32)
  ...
  (func $_ZN3std9panicking11panic_count8increase17h3de8e2b47e9166f9E (type 3) (param i32) (result i32)
    ...
    local.get 1)
  (func $_RNvCs691rhTbG0Ee_7___rustc17rust_begin_unwind (type 9) (param i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_ZN92_$LT$std..panicking..begin_panic_handler..StaticStrPayload$u20$as$u20$core..fmt..Display$GT$3fmt17h1300d7785d2cb8e7E (type 1) (param i32 i32) (result i32)
    ...
    i32.load offset=4
    call $_ZN4core3fmt9Formatter9write_str17h5f591b7d46bcc7dbE)
  (func $_ZN3std9panicking20rust_panic_with_hook17hc276d0501ad5b954E (type 8) (param i32 i32 i32 i32 i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_RNvCs691rhTbG0Ee_7___rustc18___rust_start_panic (type 1) (param i32 i32) (result i32)
    unreachable)
  (func $_ZN61_$LT$dlmalloc..sys..System$u20$as$u20$dlmalloc..Allocator$GT$5alloc17hd536f0311f53ebe2E (type 5) (param i32 i32 i32)
    (local i32)
    local.get 2
    i32.const 16
    i32.shr_u
    ...
    select
    i32.store)
  (func $_ZN5alloc7raw_vec17capacity_overflow17hfc61731a92216a2cE (type 9) (param i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
    ...
    call $_ZN4core9panicking9panic_fmt17h41cfed79b2ddbf13E
    unreachable)
  (func $_ZN5alloc7raw_vec12handle_error17h57ad9ee517c44fc6E (type 5) (param i32 i32 i32)
    block  ;; label = @1
      local.get 0
      i32.eqz
      br_if 0 (;@1;)
  ...
  (func $_ZN5alloc5alloc18handle_alloc_error17h538ce9133f14f3ccE (type 0) (param i32 i32)
    ...
    unreachable)
  (func $_ZN4core5slice5index26slice_start_index_len_fail17h026a9215e79c1fdbE (type 5) (param i32 i32 i32)
    local.get 0
    local.get 1
    local.get 2
    call $_ZN4core5slice5index26slice_start_index_len_fail8do_panic7runtime17he2583cd0648d1116E
    unreachable)
  (func $_ZN4core5slice5index24slice_end_index_len_fail17hadfbc7e1a15974a1E (type 5) (param i32 i32 i32)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_ZN4core3fmt9Formatter3pad17h5a5f539bbb272398E (type 2) (param i32 i32 i32) (result i32)
    ...
    local.get 8)
  (func $_ZN4core9panicking5panic17hcb4f0bfb9f36a348E (type 5) (param i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN4core3str5count14do_count_chars17hfba32584e02717a7E (type 1) (param i32 i32) (result i32)
    ...
    local.get 3)
  (func $_ZN4core6result13unwrap_failed17h4e312bd8e5eb4431E (type 8) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 64
    i32.sub
    ...
    call $_ZN4core9panicking9panic_fmt17h41cfed79b2ddbf13E
    unreachable)
  (func $_ZN4core5slice5index22slice_index_order_fail17h87f34a99f306396eE (type 5) (param i32 i32 i32)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_ZN4core3fmt9Formatter9write_str17h5f591b7d46bcc7dbE (type 2) (param i32 i32 i32) (result i32)
    ...
    i32.load offset=12
    call_indirect (type 2))
  (func $_ZN4core5slice5index26slice_start_index_len_fail8do_panic7runtime17he2583cd0648d1116E (type 5) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
    ...
    call $_ZN4core9panicking9panic_fmt17h41cfed79b2ddbf13E
    unreachable)
  (func $_ZN4core5slice5index24slice_end_index_len_fail8do_panic7runtime17h911bca498e89ce56E (type 5) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
    ...
    call $_ZN4core9panicking9panic_fmt17h41cfed79b2ddbf13E
    unreachable)
  (func $_ZN4core5slice5index22slice_index_order_fail8do_panic7runtime17h7ba96d6775765185E (type 5) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
    ...
    call $_ZN4core9panicking9panic_fmt17h41cfed79b2ddbf13E
    unreachable)
  (func $_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$15copy_from_slice17len_mismatch_fail17hfc67e42bedcb4f60E (type 5) (param i32 i32 i32)
    local.get 1
    local.get 0
    local.get 2
    ...
    unreachable)
  (func $_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$15copy_from_slice17len_mismatch_fail8do_panic7runtime17h33872926555474c8E (type 5) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
