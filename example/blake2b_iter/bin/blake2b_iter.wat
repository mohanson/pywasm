(module $blake2b_iter.wasm
  ...
  (func $blake2b_iter (type 3) (param i32) (result i32)
  ...
  (func $_RNvCs691rhTbG0Ee_7___rustc14___rust_realloc (type 5) (param i32 i32 i32 i32) (result i32)
    ...
    local.get 4
    return)
  (func $_RNvCs691rhTbG0Ee_7___rustc19___rust_alloc_zeroed (type 2) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    local.get 1
  ...
  (func $_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$7reserve21do_reserve_and_handle17h9d7cabd5071c5a51E (type 7) (param i32 i32 i32 i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $_ZN4core3fmt5Write9write_fmt17hc808c42956869ae8E (type 2) (param i32 i32) (result i32)
    local.get 0
    i32.const 1048992
    local.get 1
  ...
  (func $_ZN4core5panic12PanicPayload6as_str17h3575ee572e511855E (type 0) (param i32 i32)
    ...
    i32.const 0
    i32.store)
  (func $_ZN58_$LT$alloc..string..String$u20$as$u20$core..fmt..Write$GT$10write_char17h61f319b0423b9825E (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32)
    local.get 0
    i32.load offset=8
    local.set 2
    ...
    i32.store offset=8
    i32.const 0)
  (func $_ZN58_$LT$alloc..string..String$u20$as$u20$core..fmt..Write$GT$9write_str17h7850057311a0cef1E (type 1) (param i32 i32 i32) (result i32)
    (local i32)
    block  ;; label = @1
      local.get 2
      local.get 0
  ...
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$6malloc17h90ff8eedc9c6744dE (type 3) (param i32) (result i32)
                    ...
                    block  ;; label = @9
                      ...
                      block  ;; label = @10
                        ...
                        block  ;; label = @11
                          ...
                          i32.store offset=4
                          i32.const 0
                          i64.load offset=1050008 align=4
                          local.set 10
                          local.get 8
                          i32.const 16
                          i32.add
                          i32.const 0
                          i64.load offset=1050016 align=4
                          i64.store align=4
                          local.get 8
                          local.get 10
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$8memalign17h0e39a8832380600bE (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32)
    i32.const 0
    local.set 2
    block  ;; label = @1
  ...
  (func $_RNvCs691rhTbG0Ee_7___rustc13___rdl_realloc (type 5) (param i32 i32 i32 i32) (result i32)
    ...
    i32.store offset=1050308
    local.get 0)
  (func $_RNvCs691rhTbG0Ee_7___rustc18___rdl_alloc_zeroed (type 2) (param i32 i32) (result i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 1
        i32.const 9
  ...
  (func $_ZN102_$LT$std..panicking..begin_panic_handler..FormatStringPayload$u20$as$u20$core..panic..PanicPayload$GT$3get17he84c4c3017ddad6dE (type 0) (param i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $_ZN95_$LT$std..panicking..begin_panic_handler..FormatStringPayload$u20$as$u20$core..fmt..Display$GT$3fmt17h22bfd80d379a9576E (type 2) (param i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN99_$LT$std..panicking..begin_panic_handler..StaticStrPayload$u20$as$u20$core..panic..PanicPayload$GT$6as_str17h4b3ad1b286f4163aE (type 0) (param i32 i32)
    ...
    i64.load align=4
    i64.store)
  (func $_ZN92_$LT$std..panicking..begin_panic_handler..StaticStrPayload$u20$as$u20$core..fmt..Display$GT$3fmt17h1300d7785d2cb8e7E (type 2) (param i32 i32) (result i32)
    local.get 1
    local.get 0
    i32.load
    local.get 0
  ...
  (func $_ZN4core9panicking9panic_fmt17h41cfed79b2ddbf13E (type 0) (param i32 i32)
    ...
    unreachable)
  (func $_ZN4core3fmt5write17h68542eb4423e8992E (type 1) (param i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 1)
  (func $_ZN4core3fmt3num3imp21_$LT$impl$u20$u32$GT$4_fmt17habc228f2dba507bcE (type 1) (param i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_ZN4core3fmt9Formatter12pad_integral17hafdfc3db6446f97dE (type 10) (param i32 i32 i32 i32 i32 i32) (result i32)
    ...
    local.get 12)
  (func $_ZN4core3str5count14do_count_chars17hfba32584e02717a7E (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 1
  ...
  (func $_ZN4core5slice5index22slice_index_order_fail17h87f34a99f306396eE (type 4) (param i32 i32 i32)
    ...
    unreachable)
  (func $_ZN4core3fmt3num3imp52_$LT$impl$u20$core..fmt..Display$u20$for$u20$u32$GT$3fmt17h10d43ed3b5ffe62fE (type 2) (param i32 i32) (result i32)
    local.get 0
    i32.load
    i32.const 1
    local.get 1
  ...
  (func $_ZN4core3fmt9Formatter12pad_integral12write_prefix17h9b7f224add674e2aE (type 11) (param i32 i32 i32 i32 i32) (result i32)
    ...
    i32.load offset=12
    call_indirect (type 1))
  (func $_ZN4core3fmt9Formatter9write_str17h5f591b7d46bcc7dbE (type 1) (param i32 i32 i32) (result i32)
    local.get 0
    i32.load
    local.get 1
    local.get 2
