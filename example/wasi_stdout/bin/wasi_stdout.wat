(module $wasi_stdout-222d6f9d6b1efa5b.wasm
  (type (;0;) (func))
  ...
  (func $_start (type 0)
    ...
    unreachable)
  (func $_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17hc7c02efa983a4fd4E (type 3) (param i32) (result i32)
    local.get 0
    i32.load
    call $_ZN3std3sys9backtrace28__rust_begin_short_backtrace17hd17469c71a186851E
    i32.const 0)
  (func $_ZN3std3sys9backtrace28__rust_begin_short_backtrace17hd17469c71a186851E (type 1) (param i32)
    local.get 0
    call_indirect (type 0))
  (func $_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17h814cff846eaa5a4dE (type 3) (param i32) (result i32)
    local.get 0
    i32.load
    call $_ZN3std3sys9backtrace28__rust_begin_short_backtrace17hd17469c71a186851E
    i32.const 0)
  (func $_ZN11wasi_stdout4main17h5fadcf703e1f465eE (type 0)
    (local i32)
  ...
  (func $_ZN3std3sys4sync4once10no_threads4Once4call17h5c54e46b69727327E (type 1) (param i32)
    ...
    block  ;; label = @1
      block  ;; label = @2
                ...
                block  ;; label = @7
                  block  ;; label = @8
                    block  ;; label = @9
                      block  ;; label = @10
                        i32.const 0
                        i32.load8_u offset=1055526
                        br_table 0 (;@10;) 2 (;@8;) 1 (;@9;) 9 (;@1;) 0 (;@10;)
                      end
                      i32.const 0
                      i32.const 2
                      i32.store8 offset=1055526
                      local.get 0
                      i32.load8_u
                      local.set 2
                      local.get 0
        ...
        i64.store offset=1055548 align=4
        i32.const 0
        i32.const 0
        i32.load offset=1055544
        i32.const 1
  ...
  (func $_ZN3std3sys9backtrace4lock17h8474d9d758c64cbdE (type 9) (result i32)
    ...
    global.set $__stack_pointer
    i32.const 0
    i32.load8_u offset=1055577
    local.set 1
    i32.const 0
    i32.const 1
    i32.store8 offset=1055577
    local.get 0
    local.get 1
    i32.store8 offset=7
    block  ;; label = @1
  ...
  (func $_ZN3std9panicking12default_hook28_$u7b$$u7b$closure$u7d$$u7d$17h10e421fa9b730a1bE (type 4) (param i32 i32 i32)
    ...
    block  ;; label = @1
      ...
      i32.const 0
      i32.load8_u offset=1055508
      local.set 0
      i32.const 0
      i32.const 0
      i32.store8 offset=1055508
      local.get 0
      i32.eqz
      br_if 0 (;@1;)
      local.get 3
  ...
  (func $_ZN3std9panicking11panic_count8increase17h8f96eac579e666bcE (type 3) (param i32) (result i32)
    ...
    block  ;; label = @1
      ...
      local.set 1
      i32.const 0
      i32.load8_u offset=1055628
      br_if 0 (;@1;)
      i32.const 0
      local.get 0
      i32.store8 offset=1055628
      i32.const 0
      i32.const 0
      i32.load offset=1055624
      i32.const 1
      i32.add
      i32.store offset=1055624
      i32.const 2
      local.set 1
    end
    local.get 1)
          ...
          block  ;; label = @4
            block  ;; label = @5
                          ...
                          block  ;; label = @12
                            block  ;; label = @13
                              ...
                              block  ;; label = @14
                                ...
                                i32.const 0
                                i64.const -1
                                i64.store offset=1056124 align=4
                                i32.const 0
              ...
              block  ;; label = @6
                ...
                i32.add
                i32.const 0
                i64.load offset=1056096 align=4
                i64.store align=4
                local.get 9
                i32.const 0
