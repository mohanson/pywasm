(module $wasi_print-b1fc15e7abf2c172.wasm
  (type (;0;) (func))
  ...
  (func $_start (type 0)
    ...
    unreachable)
  (func $_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17h1410cac2d5961b6cE (type 3) (param i32) (result i32)
    local.get 0
    i32.load
    call $_ZN3std3sys9backtrace28__rust_begin_short_backtrace17h81e5fdd30a6ae6afE
    i32.const 0)
  (func $_ZN3std3sys9backtrace28__rust_begin_short_backtrace17h81e5fdd30a6ae6afE (type 1) (param i32)
    local.get 0
    call_indirect (type 0))
  (func $_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17hb9200fc123f296ddE (type 3) (param i32) (result i32)
    local.get 0
    i32.load
    call $_ZN3std3sys9backtrace28__rust_begin_short_backtrace17h81e5fdd30a6ae6afE
    i32.const 0)
  (func $_ZN10wasi_print4main17hf530fab6740f94f5E (type 0)
    (local i32)
