(module $blake2b.wasm
  ...
  (func $__rust_alloc_error_handler (type 0) (param i32 i32)
    ...
    call $__rg_oom
    return)
  (func $_ZN8blake2ya7blake2b6reduce17hce9cc40fc7481622E (type 7) (param i32 i32 i64 i64 i64 i64)
  ...
  (func $_ZN8blake2ya7blake2b7Param2b6digest17hec12fe20cb3aec71E (type 0) (param i32 i32)
    ...
    local.get 1
    i32.store8)
  (func $_ZN8blake2ya7blake2b7Blake2b6update17h23a8d8fd43871b5bE (type 5) (param i32 i32 i32)
    ...
    unreachable)
  (func $_ZN8blake2ya7blake2b7Blake2b6digest17h76838ece2e04fba6E (type 5) (param i32 i32 i32)
  ...
  (func $_ZN36_$LT$T$u20$as$u20$core..any..Any$GT$7type_id17he4d2fe6d646ce06fE (type 0) (param i32 i32)
    ...
    i64.store)
  (func $_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$7reserve21do_reserve_and_handle17hb98692ab7fe6ab7fE (type 8) (param i32 i32 i32 i32 i32)
  ...
  (func $_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17h754849e789348a4dE (type 9) (param i32)
    (local i32)
    block  ;; label = @1
      local.get 0
      i32.load
  ...
  (func $_ZN4core3ptr77drop_in_place$LT$std..panicking..begin_panic_handler..FormatStringPayload$GT$17hb1289cf6f1496592E (type 9) (param i32)
    (local i32)
    block  ;; label = @1
      local.get 0
      i32.load
  ...
  (func $_ZN58_$LT$alloc..string..String$u20$as$u20$core..fmt..Write$GT$9write_str17h7abd7ca86aa58925E (type 1) (param i32 i32 i32) (result i32)
    ...
    i32.store offset=8
    i32.const 0)
  (func $_ZN5alloc7raw_vec11finish_grow17hbeceac32ae425d3fE (type 4) (param i32 i32 i32 i32)
    (local i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 2
  ...
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$18insert_large_chunk17ha51abd6cd7031e06E (type 0) (param i32 i32)
    ...
    local.get 0
    i32.store offset=8)
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$4free17hbb624227e39e47e9E (type 9) (param i32)
  ...
  (func $_ZN8dlmalloc8dlmalloc17Dlmalloc$LT$A$GT$8memalign17h1d4b2c605e5367c5E (type 2) (param i32 i32) (result i32)
    ...
    local.get 2)
  (func $_ZN3std3sys9backtrace26__rust_end_short_backtrace17h8eb99c908c86e40bE (type 9) (param i32)
    local.get 0
    call $_ZN3std9panicking19begin_panic_handler28_$u7b$$u7b$closure$u7d$$u7d$17h83b3d84f04c7372bE
    unreachable)
  (func $_ZN3std9panicking19begin_panic_handler28_$u7b$$u7b$closure$u7d$$u7d$17h83b3d84f04c7372bE (type 9) (param i32)
    (local i32 i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_ZN92_$LT$std..panicking..begin_panic_handler..StaticStrPayload$u20$as$u20$core..fmt..Display$GT$3fmt17h12a3052156fbd475E (type 2) (param i32 i32) (result i32)
    ...
    i32.load offset=4
    call $_ZN4core3fmt9Formatter9write_str17h4abba99f2e253f35E)
  (func $_ZN3std9panicking20rust_panic_with_hook17hb39abb160cd4038cE (type 8) (param i32 i32 i32 i32 i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $__rust_start_panic (type 2) (param i32 i32) (result i32)
    unreachable)
  (func $_ZN61_$LT$dlmalloc..sys..System$u20$as$u20$dlmalloc..Allocator$GT$5alloc17hf38218fce26a9c00E (type 5) (param i32 i32 i32)
    (local i32)
    local.get 2
    i32.const 16
    i32.shr_u
    ...
    select
    i32.store)
  (func $_ZN5alloc7raw_vec17capacity_overflow17hbc71c29d4abc75a0E (type 9) (param i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$8grow_one17h57212a4e3c838e92E (type 0) (param i32 i32)
    ...
    i32.add
    global.set $__stack_pointer)
  (func $_ZN5alloc7raw_vec12handle_error17hcd6c5f33527353caE (type 5) (param i32 i32 i32)
    block  ;; label = @1
      local.get 0
      br_if 0 (;@1;)
      local.get 2
    ...
    call $_ZN5alloc5alloc18handle_alloc_error17haa33c1301de96704E
    unreachable)
  (func $_ZN5alloc7raw_vec11finish_grow17hd640c6805a3fe5d3E (type 4) (param i32 i32 i32 i32)
    (local i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 2
  ...
  (func $_ZN5alloc5alloc18handle_alloc_error17haa33c1301de96704E (type 0) (param i32 i32)
    ...
    unreachable)
  (func $_ZN4core5slice5index26slice_start_index_len_fail17h6ba96fe804246016E (type 5) (param i32 i32 i32)
    local.get 0
    local.get 1
    local.get 2
    call $_ZN4core5slice5index26slice_start_index_len_fail8do_panic7runtime17h8f5f6eb23a09cf83E
    unreachable)
  (func $_ZN4core5slice5index24slice_end_index_len_fail17hddeff0f8fd5a93e3E (type 5) (param i32 i32 i32)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_ZN4core3fmt9Formatter3pad17hc11ca54d5ab5b124E (type 1) (param i32 i32 i32) (result i32)
    ...
    i32.load offset=12
    call_indirect (type 1))
  (func $_ZN4core9panicking5panic17hb7d13004db45f2e3E (type 5) (param i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN4core6result13unwrap_failed17he8f1ea0683e142ebE (type 8) (param i32 i32 i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 64
    i32.sub
    ...
    call $_ZN4core9panicking9panic_fmt17h6f4dae69dcc1a6d2E
    unreachable)
  (func $_ZN4core5slice5index22slice_index_order_fail17h45c0711bdbeba6b0E (type 5) (param i32 i32 i32)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_ZN4core3fmt9Formatter9write_str17h4abba99f2e253f35E (type 1) (param i32 i32 i32) (result i32)
    ...
    i32.load offset=12
    call_indirect (type 1))
  (func $_ZN4core5slice5index26slice_start_index_len_fail8do_panic7runtime17h8f5f6eb23a09cf83E (type 5) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
    ...
    call $_ZN4core9panicking9panic_fmt17h6f4dae69dcc1a6d2E
    unreachable)
  (func $_ZN4core5slice5index24slice_end_index_len_fail8do_panic7runtime17h7780901f520234faE (type 5) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
    ...
    call $_ZN4core9panicking9panic_fmt17h6f4dae69dcc1a6d2E
    unreachable)
  (func $_ZN4core5slice5index22slice_index_order_fail8do_panic7runtime17h88e230a95f697701E (type 5) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
    ...
    call $_ZN4core9panicking9panic_fmt17h6f4dae69dcc1a6d2E
    unreachable)
  (func $_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$15copy_from_slice17len_mismatch_fail17h0920f35544df82f7E (type 5) (param i32 i32 i32)
    local.get 1
    local.get 0
    local.get 2
    ...
    unreachable)
  (func $_ZN4core5slice29_$LT$impl$u20$$u5b$T$u5d$$GT$15copy_from_slice17len_mismatch_fail8do_panic7runtime17h87418eea28dfe12eE (type 5) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
