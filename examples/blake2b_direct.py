...
m = runtime.instance_from_file('examples/blake2b_direct/bin/blake2b_direct.wasm')
...
runtime.invocate(m, 'dealloc', [data_ptr, data_size])
runtime.invocate(m, 'dealloc', [hash_ptr, hash_size])
