...
def test_num():
    ...
    for _ in range(16):
        ...
        if b == 0:
            b = 1
        assert vm.exec('u8_div', [a, b]) == wasmi.common.into_u8(wasmi.common.into_u32(a) // wasmi.common.into_u32(b))

    # for _ in range(16):
    #     a = wasmi.common.into_i16(random.randint(wasmi.common.I64_MIN, wasmi.common.I64_MAX))
    #     b = wasmi.common.into_i16(random.randint(wasmi.common.I64_MIN, wasmi.common.I64_MAX))
    #     assert vm.exec('u16_add', [a, b]) == wasmi.common.into_i16(a + b)
    # for _ in range(16):
    #     a = wasmi.common.into_i16(random.randint(wasmi.common.I64_MIN, wasmi.common.I64_MAX))
    #     b = wasmi.common.into_i16(random.randint(wasmi.common.I64_MIN, wasmi.common.I64_MAX))
    #     assert vm.exec('u16_sub', [a, b]) == wasmi.common.into_i16(a - b)
    # for _ in range(16):
    #     a = wasmi.common.into_i16(random.randint(wasmi.common.I64_MIN, wasmi.common.I64_MAX))
    #     b = wasmi.common.into_i16(random.randint(wasmi.common.I64_MIN, wasmi.common.I64_MAX))
    #     assert vm.exec('u16_mul', [a, b]) == wasmi.common.into_i16(a * b)
    # for _ in range(16):
    #     a = wasmi.common.into_i16(random.randint(wasmi.common.I64_MIN, wasmi.common.I64_MAX))
    #     b = wasmi.common.into_i16(random.randint(wasmi.common.I64_MIN, wasmi.common.I64_MAX))
    #     if b == 0:
    #         b = 1
    #     assert vm.exec('u16_div', [a, b]) == wasmi.common.into_i16(a // b)
    ...
    #     if b == 0:
    #         b = 1
    #     assert vm.exec('u32_div', [a, b]) == wasmi.common.into_i32(a // b)
    ...
    #     if b == 0:
    #         b = 1
    #     assert vm.exec('u64_div', [a, b]) == wasmi.common.into_i64(a // b)
