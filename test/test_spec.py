...
if __name__ == '__main__':
    ...
    # [TODO] case('./res/spectest/int_exprs')
    ...
    # [TODO] case('./res/spectest/memory_size')
    # [TODO] case('./res/spectest/memory_trap')
    # [TODO] case('./res/spectest/names')
    # [TODO] case('./res/spectest/nop')
    case('./res/spectest/return')
    # [TODO] case('./res/spectest/select')
