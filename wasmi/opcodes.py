...
OP_INFO[GET_LOCAL] = ('GET_LOCAL', ['leb_32'], 0)
OP_INFO[SET_LOCAL] = ('SET_LOCAL', ['leb_32'], 0)
OP_INFO[TEE_LOCAL] = ('TEE_LOCAL', ['leb_32'], 0)
OP_INFO[GET_GLOBAL] = ('GET_GLOBAL', ['leb_32'], 0)
OP_INFO[SET_GLOBAL] = ('SET_GLOBAL', ['leb_32'], 0)
OP_INFO[I32_LOAD] = ('I32_LOAD', ['leb_32', 'leb_32'], 4)
OP_INFO[I64_LOAD] = ('I64_LOAD', ['leb_32', 'leb_32'], 8)
OP_INFO[F32_LOAD] = ('F32_LOAD', ['leb_32', 'leb_32'], 4)
OP_INFO[F64_LOAD] = ('F64_LOAD', ['leb_32', 'leb_32'], 8)
OP_INFO[I32_LOAD_8s] = ('I32_LOAD_8s', ['leb_32', 'leb_32'], 1)
OP_INFO[I32_LOAD_8u] = ('I32_LOAD_8u', ['leb_32', 'leb_32'], 1)
OP_INFO[I32_LOAD_16s] = ('I32_LOAD_16s', ['leb_32', 'leb_32'], 2)
OP_INFO[I32_LOAD_16u] = ('I32_LOAD_16u', ['leb_32', 'leb_32'], 2)
OP_INFO[I64_LOAD_8s] = ('I64_LOAD_8s', ['leb_32', 'leb_32'], 1)
OP_INFO[I64_LOAD_8u] = ('I64_LOAD_8u', ['leb_32', 'leb_32'], 1)
OP_INFO[I64_LOAD_16s] = ('I64_LOAD_16s', ['leb_32', 'leb_32'], 2)
OP_INFO[I64_LOAD_16u] = ('I64_LOAD_16u', ['leb_32', 'leb_32'], 2)
OP_INFO[I64_LOAD_32s] = ('I64_LOAD_32s', ['leb_32', 'leb_32'], 4)
OP_INFO[I64_LOAD_32u] = ('I64_LOAD_32u', ['leb_32', 'leb_32'], 4)
OP_INFO[I32_STORE] = ('I32_STORE', ['leb_32', 'leb_32'], 4)
OP_INFO[I64_STORE] = ('I64_STORE', ['leb_32', 'leb_32'], 8)
OP_INFO[F32_STORE] = ('F32_STORE', ['leb_32', 'leb_32'], 4)
OP_INFO[F64_STORE] = ('F64_STORE', ['leb_32', 'leb_32'], 8)
OP_INFO[I32_STORE8] = ('I32_STORE8', ['leb_32', 'leb_32'], 1)
OP_INFO[I32_STORE16] = ('I32_STORE16', ['leb_32', 'leb_32'], 2)
OP_INFO[I64_STORE8] = ('I64_STORE8', ['leb_32', 'leb_32'], 1)
OP_INFO[I64_STORE16] = ('I64_STORE16', ['leb_32', 'leb_32'], 2)
OP_INFO[I64_STORE32] = ('I64_STORE32', ['leb_32', 'leb_32'], 4)
OP_INFO[CURRENT_MEMORY] = ('CURRENT_MEMORY', ['leb_1'], 0)
OP_INFO[GROW_MEMORY] = ('GROW_MEMORY', ['leb_1'], 1)
OP_INFO[I32_CONST] = ('I32_CONST', ['leb_32'], 2)
OP_INFO[I64_CONST] = ('I64_CONST', ['leb_64'], 1)
OP_INFO[F32_CONST] = ('F32_CONST', ['bit_32'], 2)
OP_INFO[F64_CONST] = ('F64_CONST', ['bit_64'], 4)
